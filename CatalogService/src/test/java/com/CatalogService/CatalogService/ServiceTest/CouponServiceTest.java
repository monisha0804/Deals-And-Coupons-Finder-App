...
public class CouponServiceTest {
	...
	public void findByIdTest() throws CatalogRequestException {
		when (couponRepository.findById("2")).thenReturn(Optional.of(new Coupon("2","food",12, "12%", "EdnaBakery")));
	...
	public void findallTest() {
		Coupon c1=new Coupon("1","food",12, "12%", "EdnaBakery");
		Coupon c2=new Coupon("2","food",12, "12%", "EdnaBakery");
		Coupon c3=new Coupon("3","food",12, "12%", "EdnaBakery");
		Coupon c4=new Coupon("4","food",12, "12%", "EdnaBakery");
	...
	@Test 
	 public void deleteByIdTest() throws CatalogRequestException {
		when (couponRepository.findById("6")).thenReturn(Optional.of(new Coupon("6","food",12, "12%", "EdnaBakery")));
	...
	public void findByCategoryTest() {
		Optional<Coupon> c1=Optional.of(new Coupon("1","food",12, "12%", "EdnaBakery"));
		Optional<Coupon> c3=Optional.of(new Coupon("3","food",12, "12%", "EdnaBakery"));
	...
	public void findByCompanyNameTest() {
		Optional<Coupon> c1=Optional.of(new Coupon("1","food",12, "12%", "EdnaBakery"));
		Optional<Coupon> c2=Optional.of(new Coupon("3","food",12, "12%", "EdnaBakery"));
		List<Optional<Coupon>> coupon= new ArrayList<>();
		coupon.add(c1);
		coupon.add(c2);
